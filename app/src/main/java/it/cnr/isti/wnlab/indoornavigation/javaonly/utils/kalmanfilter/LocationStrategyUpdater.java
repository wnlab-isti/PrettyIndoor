package it.cnr.isti.wnlab.indoornavigation.javaonly.utils.kalmanfilter;
...
import it.cnr.isti.wnlab.indoornavigation.javaonly.filters.kalmanfilter.adapters.KalmanFilterUpdater;
...
public class LocationStrategyUpdater extends KalmanFilterUpdater {
    ...
    private List<IndoorLocalizationStrategy> mStrategies;
    ...
    public LocationStrategyUpdater(
            ...
            IndoorLocalizationStrategy... strategies) {
        super(filter);
        this.filter = filter;
        ...
        for(IndoorLocalizationStrategy s : mStrategies) {
